...
public class ClosestPointsTest
{
    ...
    {
        // when
        (Point2D, Point2D) result = ClosestPoints.FindClosestPoints([Point2D.Of(2, 2)]);
    ...
    public void FindClosestPoints_WhenTwoPoints_ThenThesePoints()
    {
        ...
        (Point2D, Point2D) result =
                ClosestPoints.FindClosestPoints([Point2D.Of(2, 2), Point2D.Of(4, 4)]);
    ...
    public void FindClosestPoints_WhenThreePoints_ThenPairOfClosestPoints()
    {
        // when
        (Point2D, Point2D) result =
            ClosestPoints.FindClosestPoints([Point2D.Of(3, 2), Point2D.Of(1, 1), Point2D.Of(7, 0)]);
    ...
    public void FindClosestPoints_WhenMultiplePoints_ThenPairOfClosestPoints()
    {
        ...
        (Point2D, Point2D) result = ClosestPoints.FindClosestPoints(
                [Point2D.Of(1, 1), Point2D.Of(-2, 2), Point2D.Of(-4, 4), Point2D.Of(3, -3),
    ...
    public void FindClosestPoints_WhenAllLinearOnX_ThenPairOfClosestPoints()
    {
        // when
        (Point2D, Point2D) result = ClosestPoints.FindClosestPoints(
                [Point2D.Of(14, -40), Point2D.Of(14, -3), Point2D.Of(14, 36), Point2D.Of(14, 7),
                 Point2D.Of(14, -24), Point2D.Of(14, 1), Point2D.Of(14, -14), Point2D.Of(14, 19)]);
    ...
    public void FindClosestPoints_WhenAllLinearOnY_ThenPairOfClosestPoints()
    {
        // when
        (Point2D, Point2D) result = ClosestPoints.FindClosestPoints(
                [Point2D.Of(-27, -6), Point2D.Of(13, -6), Point2D.Of(-8, -6), Point2D.Of(30, -6),
                 Point2D.Of(6, -6), Point2D.Of(-15, -6), Point2D.Of(-3, -6), Point2D.Of(22, -6)]);
