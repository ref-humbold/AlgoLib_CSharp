...
public static class MinimalSpanningTree
{
    ...
    public static IUndirectedGraph<TVertexId, TVertexProperty, TEdgeProperty> Kruskal<TVertexId,
        TVertexProperty, TEdgeProperty>(
        ...
        where TEdgeProperty : IWeighted
    {
        ...
        var vertexSets = new DisjointSets<Vertex<TVertexId>>(
            graph.Vertices.Select(v => new[] { v }));
        var edgeHeap = new Heap<Edge<TVertexId>>((edge1, edge2) =>
            graph.Properties[edge1].Weight.CompareTo(graph.Properties[edge2].Weight));
    ...
    /// <returns>The minimal spanning tree.</returns>
    public static IUndirectedGraph<TVertexId, TVertexProperty, TEdgeProperty> Prim<TVertexId,
        TVertexProperty, TEdgeProperty>(
        ...
        where TEdgeProperty : IWeighted
    {
        ...
        var heap = new Heap<(Edge<TVertexId>, Vertex<TVertexId>)>((pair1, pair2) =>
            graph.Properties[pair1.Item1].Weight.CompareTo(graph.Properties[pair2.Item1].Weight));
